...
public static Map<String, Map<String, String>> setMapData() throws Exception{
		...
		String path = System.getProperty("user.dir")+"/src/test/resource/dataSheets/AmzaonDataSheet.xlsx";
		...
		for (int i = 0; i<=lastRow; i++){					//Looping over entire row
			...
			excelFileMap.put("AmzaonDataSheet", dataMap);		//Putting dataMap to excelFileMap
		}
	...
	public static String getMapData(String key) throws Exception{
		Map<String, String> m = setMapData().get("AmzaonDataSheet");
